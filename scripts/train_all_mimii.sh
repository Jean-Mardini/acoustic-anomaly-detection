...
echo "Starting training for all MIMII-DUE machine types"
...
print('-' * 55)
for m in machines:
    p1 = Path(f'artifacts/runs/mimii_{m}_v1/evaluation_mahalanobis.json')
    p2 = Path(f'artifacts/runs/mimii_{m}_v1/evaluation_gmm.json')
